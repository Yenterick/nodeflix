...
test.describe('Register Tests', () => {
    ...
    // FIXME: Test from 4 to 6 failing idk why

    // Test trying to register without a valid email
    test('Register with an invalid email', async ({ page }) => {
        await page.getByPlaceholder('Insert your email...').fill('wrong');
        await page.getByPlaceholder('Insert your password...', { exact: true }).fill('wrongPassword');
    ...
    test('Register with mismatched passwords', async ({ page }) => {
        await page.getByPlaceholder('Insert your email...').fill('test@test.com');
        await page.getByPlaceholder('Insert your password...', { exact: true }).fill('password123');
    ...
    test('Register with an already existing email', async ({ page }) => {
        await page.getByPlaceholder('Insert your email...').fill('test@test.com');
        await page.getByPlaceholder('Insert your password...', { exact: true }).fill('test');
    ...
    test('Register with correct credentials', async ({ page }) => {
        ...
        await page.getByPlaceholder('Insert your email...').fill(uniqueEmail);
        await page.getByPlaceholder('Insert your password...', { exact: true }).fill('password123');
